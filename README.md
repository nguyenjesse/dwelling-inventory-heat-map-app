...
app/                               Modular source (dev version)
  ...
  js/                              model, storage, form, map, panel, heatmap, importexport, opbuild, editor…
  css/                             styles
...
and CSV/JSON import/export round-trips, plus seed-derived categories, the
site-namespaced counts key, and the in-browser operator-file generation. It
currently runs **47/47 green**.
